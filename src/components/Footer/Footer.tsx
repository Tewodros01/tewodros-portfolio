      ...
      <div className="relative z-20 grid grid-cols-1 items-start gap-20 md:grid-cols-2 md:gap-12">
        <div>
          <h5 className="mb-8 flex items-center gap-2">
            ...
            <span className="text-neutral text-lg font-medium">Tewodros Misawoy </span>
          </h5>
          <p className="text-tertiary-content">
            Full-Stack Developer crafting modern web and mobile solutions for startups and
            enterprises.
          </p>
          <a
            href="https://www.linkedin.com/in/tewodros-misawoy"
            target="_blank"
        ...
        <div className="flex flex-col justify-between gap-[200px] md:flex-row md:gap-8">
          <div className="space-y-10 md:self-end">
            <div className="flex flex-col">
              <h5 className="text-neutral m-4 text-lg font-medium">Contact</h5>
              <a
                href="mailto:tewodrosm01@gmail.com"
                className="text-tertiary-content hover:text-neutral text-sm font-light transition-colors duration-300">
                tewodrosm01@gmail.com
              </a>
              <a
                href="tel:+251 940805426"
                className="text-tertiary-content hover:text-neutral text-sm font-light transition-colors duration-300">
                +251 940805426
              </a>
            </div>
